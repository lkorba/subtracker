...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Subtracker — Track every subscription in one place" },
      { name: "description", content: "Subtracker helps you see, categorize and control every recurring subscription with beautiful monthly and annual dashboards." },
      { property: "og:title", content: "Subtracker" },
      { property: "og:description", content: "See, categorize and control every recurring subscription." },
